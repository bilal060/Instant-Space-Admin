...
const CustomerHourlyModel = ({ setLgShow, setCardAlert, singleSpace }) => {
              ...
              <Col className="p-0">
                ...
                <div className="mb-4">
                  <DatePicker
                    disableDayPicker
                    format="HH:mm"
                    plugins={[<TimePicker hideSeconds key={'endTime'} />]}
                    inputClass=" h-56px w-100 calendar-input"
                ...
                <div className="mb-4">
                  <DatePicker
                    disableDayPicker
                    format="HH:mm"
                    plugins={[<TimePicker hideSeconds key={'startTime'} />]}
                    inputClass="h-56px w-100 calendar-input"
            ...
            <Row className="justify-content-end mt-3 mb-2 gap-sm-0 gap-3">
              ...
              <Col md="6" sm="4">
                <Button
                  ...
                  disabled={!dayValue || !startHourValue || !endHourValue}>
                  Book Now
                </Button>
              </Col>
            </Row>
...
export default CustomerHourlyModel;
