...
const CustomerMonthlyModel = ({ setLgShow, setCardAlert, singleSpace }) => {
  ...
  const loginHandler = (values) => {
    ...
    } else if (monthValue === undefined || monthValue === '' || monthValue === null) {
      return;
    }
    const dates = getDatesArray(monthValue);
...
export default CustomerMonthlyModel;
